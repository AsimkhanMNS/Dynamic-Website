...
<body>
    ...
    <div class="container mt-3 " id="ims">
        <img src="Mobile login-pana.png" alt="" width="30%" class="ims">
        <h2>Sign Up</h2>
    </div>
    </div>
    <!-- LOGIN SECTION END -->
    <div class="container">
        <form action="" method="post">
            <div class="form-control  mt-2 mb-3">
                ...
                <div class="form-floating mb-3 mt-3">
                    <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="email">
                    <label for="floatingPassword">Password</label>
                </div>
                <button class="btn btn-outline-danger" type="sumbit" name="sumbit" id="button-addon1">SIGN UP</button>
            </div>
        </form>
    </div>
    <!-- FOOTER START -->
...
$inserquery ="INSERT INTO `login`(`email`,`password`) VALUES ('$name','$email')";
